...
class Dataset_Creation:
    ...
    def generate_csv_file(self, valid_emails):
    	...
    	file = open('C:\Datasets/final_dataset.csv','w')
...
emails_dataset = open('C:\Datasets/fradulent_emails.txt','r').read() #Read complete dataset as string
...
emails_dataset2 = open('C:\Datasets/spam_normal_emails.csv','r').readlines() #Read complete dataset as string
